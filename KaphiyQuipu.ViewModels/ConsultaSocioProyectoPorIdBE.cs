...
{
    public class ConsultaSocioProyectoPorIdBE
    {
        #region Properties
        /// <summary>
        /// Gets or sets the SocioProyectoId value.
        /// </summary>
        ...
        public bool CobradoSegundoDesembolso
        { get; set; }

        /// <summary>
        /// Gets or sets the FechaCobro value.
        /// </summary>
        public DateTime? FechaCobroSegundoDesembolso
        { get; set; }
