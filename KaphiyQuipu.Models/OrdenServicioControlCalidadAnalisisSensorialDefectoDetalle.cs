...
{
	public class OrdenServicioControlCalidadAnalisisSensorialDefectoDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the OrdenServicioControlCalidadAnalisisSensorialDefectoDetalleId value.
		/// </summary>
		public int OrdenServicioControlCalidadAnalisisSensorialDefectoDetalleId
		{ get; set; }
