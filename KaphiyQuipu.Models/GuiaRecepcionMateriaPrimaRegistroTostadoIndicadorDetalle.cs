...
{
	public class GuiaRecepcionMateriaPrimaRegistroTostadoIndicadorDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the GuiaRecepcionMateriaPrimaRegistroTostadoIndicadorDetalleId value.
		/// </summary>
		public int GuiaRecepcionMateriaPrimaRegistroTostadoIndicadorDetalleId
		{ get; set; }
