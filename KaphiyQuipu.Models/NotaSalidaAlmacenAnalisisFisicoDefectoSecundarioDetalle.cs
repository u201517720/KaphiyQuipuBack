...
{
	public class NotaSalidaAlmacenAnalisisFisicoDefectoSecundarioDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the NotaSalidaAlmacenAnalisisFisicoDefectoSecundarioDetalleId value.
		/// </summary>
		public int NotaSalidaAlmacenAnalisisFisicoDefectoSecundarioDetalleId
		{ get; set; }
