...
{
	public class GuiaRecepcionMateriaPrimaAnalisisFisicoDefectoPrimarioDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the GuiaRecepcionMateriaPrimaAnalisisFisicoDefectoPrimarioDetalleId value.
		/// </summary>
		public int GuiaRecepcionMateriaPrimaAnalisisFisicoDefectoPrimarioDetalleId
		{ get; set; }
