...
{
	public class LoteRegistroTostadoIndicadorDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the LoteRegistroTostadoIndicadorDetalleId value.
		/// </summary>
		public int LoteRegistroTostadoIndicadorDetalleId
		{ get; set; }
