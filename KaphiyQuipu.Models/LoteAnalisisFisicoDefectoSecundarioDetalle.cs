...
{
	public class LoteAnalisisFisicoDefectoSecundarioDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the LoteAnalisisFisicoDefectoSecundarioDetalleId value.
		/// </summary>
		public int LoteAnalisisFisicoDefectoSecundarioDetalleId
		{ get; set; }
