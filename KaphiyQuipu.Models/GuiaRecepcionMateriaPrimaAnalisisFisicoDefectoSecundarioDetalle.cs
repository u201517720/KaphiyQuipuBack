...
{
	public class GuiaRecepcionMateriaPrimaAnalisisFisicoDefectoSecundarioDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the GuiaRecepcionMateriaPrimaAnalisisFisicoDefectoSecundarioDetalleId value.
		/// </summary>
		public int GuiaRecepcionMateriaPrimaAnalisisFisicoDefectoSecundarioDetalleId
		{ get; set; }
