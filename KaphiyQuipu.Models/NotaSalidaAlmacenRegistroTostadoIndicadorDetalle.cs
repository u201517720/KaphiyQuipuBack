...
{
	public class NotaSalidaAlmacenRegistroTostadoIndicadorDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the NotaSalidaAlmacenRegistroTostadoIndicadorDetalleId value.
		/// </summary>
		public int NotaSalidaAlmacenRegistroTostadoIndicadorDetalleId
		{ get; set; }
