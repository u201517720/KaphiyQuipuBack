...
{
	public class OrdenServicioControlCalidadAnalisisFisicoDefectoSecundarioDetalle
	{
		#region Properties
		/// <summary>
		/// Gets or sets the OrdenServicioControlCalidadAnalisisFisicoDefectoSecundarioDetalleId value.
		/// </summary>
		public int OrdenServicioControlCalidadAnalisisFisicoDefectoSecundarioDetalleId
		{ get; set; }
