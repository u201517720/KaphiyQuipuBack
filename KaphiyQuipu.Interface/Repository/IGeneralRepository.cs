...
namespace KaphiyQuipu.Interface.Repository
{
    public interface IGeneralRepository
    {
        ...
        IEnumerable<string> GuardarValoracionClienteExterno(string contrato, string documento, string cliente, int puntaje, string comentario, DateTime fecha, string tipoDocumento);
    }
}
